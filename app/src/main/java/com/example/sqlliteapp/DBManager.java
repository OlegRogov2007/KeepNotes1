...
public class DBManager {
    ...
    static final String DBname="Pawsome Planner";
    ...
    static final String CreateTable="Create table IF NOT EXISTS "+TableName+ "(ID integer primary key autoincrement,"+ColDateTime+
            " text,"+ColTitle+" text,"+ColDescription+" text,"+ColRemTime+" text,"+ColRemDate+" text,"+imageView+" text);";
    ...
    static class DatabaseHelperUser extends SQLiteOpenHelper{
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            Toast.makeText(context, "Pawsome Planner", Toast.LENGTH_LONG).show();
